# asset 子站前端，打包成广州（asset.oceanleo.cn）能跑的镜像。
#
...
ARG NEXT_PUBLIC_OCEANLEO_SITE_ORIGIN=https://asset.oceanleo.cn
...
ARG NEXT_PUBLIC_SITE_URL=https://asset.oceanleo.cn
